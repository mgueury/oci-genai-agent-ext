...
-- Ingest Log in the DB
CREATE TABLE APEX_APP.AI_AGENT_RAG_INGEST_LOG (
    id NUMBER GENERATED by default on null as IDENTITY,
    status varchar2(256),
    resource_name varchar2(1024),
...
alter table "APEX_APP"."AI_AGENT_RAG_INGEST_LOG" add constraint "AI_AGENT_RAG_INGEST_LOG_PK" primary key ( "ID" );
